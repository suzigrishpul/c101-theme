...
<script>
  jQuery(window).load(function(){
    if(jQuery("#s2member-pro-paypal-checkout-custom-reg-field-terms-conditions").length>0){
      jQuery("#s2member-pro-paypal-checkout-form-custom-reg-field-terms-conditions-div").prepend('<div>Please click <a href="/?p=1438" target="_blank">here</a> to read our Terms and Conditions</div>');
    }
  });
